...
-- Create wiki categories table first (referenced by wiki_entries)
...
DROP POLICY IF EXISTS "Users can view own wiki entries" ON public.wiki_entries;
DROP POLICY IF EXISTS "Users can insert own wiki entries" ON public.wiki_entries;
DROP POLICY IF EXISTS "Users can update own wiki entries" ON public.wiki_entries;
DROP POLICY IF EXISTS "Users can delete own wiki entries" ON public.wiki_entries;

DROP POLICY IF EXISTS "Users can view own wiki categories" ON public.wiki_categories;
DROP POLICY IF EXISTS "Users can insert own wiki categories" ON public.wiki_categories;
DROP POLICY IF EXISTS "Users can update own wiki categories" ON public.wiki_categories;
DROP POLICY IF EXISTS "Users can delete own wiki categories" ON public.wiki_categories;
